package com.tts.tttwitter1.service;
...
import com.tts.tttwitter1.repository.TagRepository;
import com.tts.tttwitter1.repository.TweetRepository;
...
public class TweetService {
    ...
    private List<TweetDisplay> formatTimeStamps (List<Tweet> tweets){
        ...
        for (Tweet tweet : tweets) {
            ...
            long difInMillies = Math.abs(now.getTime() - tweet.getCreatedAt().getTime());
